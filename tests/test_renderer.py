...
def test_render_daily_report_contains_sections():
    ...
    assert "今日共收录 **2** 个 GitHub Trending 项目。" in report
...
def test_render_overview_language_distribution():
    """概览包含语言分布统计。"""
    from scripts.renderer import render_daily_report

    repos = [
        {"full_name": "a/py1", "description": "", "language": "Python",
         "stars_today": 10, "total_stars": 100, "url": "https://github.com/a/py1"},
        {"full_name": "b/py2", "description": "", "language": "Python",
         "stars_today": 20, "total_stars": 200, "url": "https://github.com/b/py2"},
        {"full_name": "c/rs1", "description": "", "language": "Rust",
         "stars_today": 5, "total_stars": 50, "url": "https://github.com/c/rs1"},
    ]
    analyses = {r["full_name"]: {"summary": "s"} for r in repos}
    ...
    assert "主要语言分布：Python(2)、Rust(1)。" in report
